...
ggsave("../pdfs/SupplementaryFigure17.pdf", plot=last_plot(), height= 225, width=170, units=c("mm"))
ggsave("../pngs/SupplementaryFigure17.png", plot=last_plot(), height= 225, width=170, units=c("mm"))